...
export const fetchInventoryByCategory = async (
  ...
  try {
    ...
    console.log("/api/v1/inventory/${id}/toggle", values);
...
export const toggleInventory = async (id: number) => {
  try {
    ...
    console.log("/api/v1/inventory/${id}/toggle", response.data);
...
export const wearingInventory = async () => {
  try {
    ...
    console.log("/api/v1/inventory/wearing 조회", response.data.data);
